...
createmenuhud() {
    ...
    self.hud.background3 = self createRectangle("TOP", "CENTER", 201, -50, 200, 23, (0,0,0), 1, 9, "white");
    self.hud.background4 = self createRectangle("TOP", "CENTER", 201, -50, 200, 15, (0,0,0), 1, 9, "white");
    self.hud.background5 = self createRectangle("TOP", "CENTER", 201, -50, 200, 15, (0,0,0), 1, 9, "white");
    ...
    self.hud.scroll = self createRectangle("TOP", "CENTER", 201, -25, 200, 15, (0.255,0.278 ,0.373), 1, 4, "white");
